...
import Pilgan2 from '../Component/Pilgan2';
...
export default function LatihanSoal2() {
  const classes = useStyles();
              ...
              <Grid item xs={12}>
                <Paper className={classes.paper}>
                  ...
                  <Typography color="textPrimary" align="left" className={classes.pertanyaan}>
                    {/* きむら : ねえ、あやこちゃん、すずきせんせいは どこ .... いますか。
                    <br/>あやこ : クラス ..... います。 */}
                    A	: しょくいんつは　どこに　ありますか。<br/>
                    B	: ４組のクラスのとなり…..あります。
                  </Typography>
                  <Pilgan2 />
                  {/* <Link to="/LatihanSoal3" className={classes.linksoal}>
                    <Button
                      type="submit"
                      variant="contained"
                      id="soal"
