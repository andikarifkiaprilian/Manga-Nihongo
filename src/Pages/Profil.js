...
import ProBreadcrumbs from '../Component/ProBreadcrumbs';
import DataProfil from '../Component/DataProfil';
          ...
          <Grid container spacing={3}>
              ...
              <Grid item xs={12}>
                <Paper className={classes.paper}>
                    <Typography variant="h6" align="center">Biodata Siswa</Typography>
                    <Divider />
                    <DataProfil />
                </Paper>
              </Grid>
